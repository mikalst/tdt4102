...
public:
    ...
    void incrementAngle(double dtheta = 1);
    void decrementAngle(double dtheta = 1);
    
    void incrementVelocity(double dvel = 5);
    void decrementVelocity(double dvel = 5);
...
public:
    ...
    // check if cannonball has hit target
    bool hitTarget(Target t);
